...
export type AdminMainTab =
  ...
  | "users"                 // 6. Quản lý người dùng & Uy tín (Users, UserProfiles)
  | "foods"                 // 7. Ẩm thực & Đặc sản (Foods, FoodPlaces, FoodProvinces)
  | "collections"           // 8. Bộ sưu tập (Collections, CollectionPlaces)
  | "provinces"             // 9. Tỉnh/Thành trong vùng (Provinces, Regions)
  | "blogs"                 // 10. Blog & Cẩm nang (Blogs)
