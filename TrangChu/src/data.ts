...
export const initialBlogArticles: BlogArticleItem[] = [
  {
    ...
    category: "Ẩm thực",
    coverImg: "https://images.unsplash.com/photo-1509072619873-adb3dc289b50?w=1400&h=800&fit=crop&auto=format",
    ...
    sections: [
      {
        ...
        image: "https://images.unsplash.com/photo-1582878826629-29b7ad1cdc43?w=900&h=500&fit=crop",
        imageCaption: "Bát phở bò tái chín rực rỡ sắc xanh của hành lá và nước dùng sóng sánh ngậy thơm",
      },
      {
        id: "sec-2",
        heading: "2. Bí mật của nồi nước dùng trong vắt ninh 12 tiếng",
        content: "Điểm phân biệt một bát phở ngon thượng hạng nằm ở linh hồn của nồi nước dùng. Người đầu bếp phải tỉ mỉ chọn từng khúc xương ống bò tươi, rửa sạch qua gừng muối rồi đem hầm liu riu suốt hơn nửa ngày. Cùng với hoa hồi nướng xém, quế chi cay nồng và thảo quả thơm dịu, nước dùng giữ được độ ngọt thanh tự nhiên từ tủy xương chứ tuyệt nhiên không lạm dụng bột ngọt.",
        image: "https://images.unsplash.com/photo-1527997921830-de1cf1f9b430?w=900&h=500&fit=crop",
  ...
  },
  {
    ...
    category: "Khám phá",
    coverImg: "https://images.unsplash.com/photo-1691927644490-e1a24b366a5e?w=1400&h=800&fit=crop&auto=format",
    authorName: "Nguyễn Minh Anh",
